...
<h1 class="margin-bottom-18">入库表</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="inreg" method="post">
				<div class="form-inner">
					<div class="form-group">
     				...
     				Connection conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
			          ...
			          String sql = "select Gno from _Goods";
			        ...
			        sql = "select Sno from _Warehouse";
    		 		stmt=conn.createStatement();
    				  rs = stmt.executeQuery(sql);
    				 while(rs.next()){%>    				
						<option value ="<%=rs.getString(1) %>"  > <%=rs.getString(1)   %></option>
			    	...
			    	<div class="form-group">
			    	 <div class="col-md-4">	
				         ...
				         <label for="date" class="control-label">入库日期:  年：</label>
			          ...
			          <div class="col-md-6">	
			           ...
			           <div class="col-md-6">	
				         ...
				         <label for="address" class="control-label">货物来源</label>
			      ...
			      <div class="col-md-6">	
				         ...
				         <label for="Spno" class="control-label">供货商</label>
			            <select style="width:100px;" name = "Spno">
			          <% 
			          Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
     				conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
     
			        sql = "select Spno from _Supplier";
    		 		stmt=conn.createStatement();
    				  rs = stmt.executeQuery(sql);
    				 while(rs.next()){%>    				
						<option value ="<%=rs.getString(1) %>"  > <%=rs.getString(1)   %></option>
			        ...
			        <div class="form-group">
			          <div class="col-md-12">
			            <input type="submit" value="入库" class="btn btn-info">
