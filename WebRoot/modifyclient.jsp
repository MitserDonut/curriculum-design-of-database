...
<html>
  <head>
	...
	<%
	Vector<ClientInfo> inv=null;
	int power=99;
	ClientInfo modi_client=new ClientInfo();
	...
	<%
	if(ms.getAttribute("ClientInfo")!=null){
	inv=(Vector<ClientInfo>)ms.getAttribute("ClientInfo");
		int row=Integer.parseInt(request.getParameter("row"));
		modi_client=inv.get(row);
	}
	 %>
  </head>
...
<h1 class="margin-bottom-18">修改客户信息</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="client?action=modify" method="post">
				<div class="form-inner">
					<div class="form-group">
			     
			          <div class="col-md-6">	
			                      <label for="name" class="control-label">客户姓名</label>
			            <input type="text" class="form-control" id="name" name="name" value=<%=modi_client.getClt_name() %>>		          	
			            	            		            		            
			          </div>    
			           <div class="col-md-6">	
			                      <label for="type" class="control-label">客户类型</label>
			            <input type="text" class="form-control" id="type" name="type" value=<%=modi_client.getClt_type() %>>		          	
			      	 ...
			      	 <div class="col-md-12">	
			          	...
			          	String nan="";
			          	String nv="";
			          	if(modi_client.getClt_sex().equals("男")){
			          		nan="checked";
			          	} 
			          	else{
			          		nv="checked";
			          ...
			          <div class="col-md-12">	
			            ...
			            <input type="text" class="form-control" id="tele" name="tele" value=<%=modi_client.getClt_tele() %>>		            		            
			          </div>    
			              </div>	       
			    	<div class="form-group">
			          <div class="col-md-12">		          	
			          ...
			          <input type="text"  value = <%=modi_client.getClt_bz() %> class="form-control" id="bz" name="bz" placeholder="">	        		            		            
			          </div>
			          </div>	
			    <%
			    ms.setAttribute("mdfcid", modi_client.getClt_no());
			     %>
