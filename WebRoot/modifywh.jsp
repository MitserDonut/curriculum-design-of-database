...
<html>
  <head>
	...
	<%
	Vector<WarehouseInfo> inv=null;
	int power=99;
	WarehouseInfo modi_wh=new WarehouseInfo();
	...
	<%
	if(ms.getAttribute("warehouseInfo")!=null){
	inv=(Vector<WarehouseInfo>)ms.getAttribute("warehouseInfo");
...
<h1 class="margin-bottom-18">修改仓库信息</h1>
	<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="Whousereg?action=modify" method="post">
				<div class="form-inner">
					<div class="form-group">
			          <div class="col-md-6">		          	
			            <label for="warename" class="control-label">仓库名</label>
			            <input type="text" class="form-control" id="warename" name="warename" value=<%=modi_wh.getWh_name() %>>		            		            		            
			          </div>  
			          <div class="col-md-6">		          	
			            <label for="saddress" class="control-label">仓库地址</label>
			            <input type="text" class="form-control" id="saddress" name="saddress" value=<%=modi_wh.getWh_adrs() %>>		            		            		            
			          </div>             
			        </div>
			        <div class="form-group">
			           <div class="col-md-6">			          	
			            <label for="wbig" class="control-label">仓库大小</label>
			            <input type="text" class="form-control" id="wbig" name=wbig value=<%=modi_wh.getWh_contain() %>>		            		            		            
			          </div>             
			        </div>
				...
				<%
				ms.setAttribute("mdfwid", modi_wh.getWh_no());
				 %>		    	
		      </form>		      
		</div>
