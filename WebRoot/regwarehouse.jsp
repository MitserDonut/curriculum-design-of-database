...
<br/><br/>
<br/>
<h1 class="margin-bottom-15">创建仓库</h1>
<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="Whousereg?action=reg" method="post">
				<div class="form-inner">
					<div class="form-group">
			          <div class="col-md-6">		          	
			            <label for="warename" class="control-label">仓库名</label>
			            <input type="text" class="form-control" id="warename" name="warename" placeholder="">		            		            		            
			          </div>  
			          <div class="col-md-6">		          	
			        ...
			        <div class="form-group">
			           <div class="col-md-6">			          	
			            ...
			            <input type="text" class="form-control" id="wbig" name=wbig placeholder="">		            		            		            
			          </div>             
			        </div>
			        
			        <div class="form-group">
			          <div class="col-md-12">
			            <input type="submit" value="创建仓库" class="btn btn-info">
