...
<h1 class="margin-bottom-18">删除管理员</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="admindel" method="post">
				<div class="form-inner">
			          ...
			          <div class="col-md-12">		          	
			            ...
			            <label for="admin" class="control-label center">管理员id</label>
     				...
     				Connection conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
			          ...
			          String sql = "select Ano,Aname from _Admin";
