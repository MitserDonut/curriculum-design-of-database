...
<h1 class="margin-bottom-18">创建客户</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="client?action=reg" method="post">
				<div class="form-inner">
			    	...
			    	<div class="form-group">
			          ...
			          <input type="text"  value = "无" class="form-control" id="bz" name="bz" placeholder="">	        		            		            
			          </div>
			          </div>	
			        ...
			        <div class="form-group">
			          <div class="col-md-12">
			            <input type="submit" value="创建客户" class="btn btn-info">
