...
<h1 class="margin-bottom-18">删除客户</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="clientdel" method="post">
				<div class="form-inner">
			          ...
			          <div class="col-md-12">		          	
			            ...
			            <label for="admin" class="control-label center">客户id</label>
     				...
     				Connection conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
			          ...
			          String sql = "select Cno,Cname from _Client";
