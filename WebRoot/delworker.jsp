...
<h1 class="margin-bottom-18">删除员工</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="workerdel" method="post">
				<div class="form-inner">
			          ...
			          <div class="col-md-12">		          	
			            ...
			            <label for="admin" class="control-label center">员工id</label>
     				...
     				Connection conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
			          ...
			          String sql = "select Wno,Wname from _Worker";
