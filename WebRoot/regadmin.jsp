...
<br/><br/>
<br/>
<h1 class="margin-bottom-18">创建管理员</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="Adminreg?action=reg" method="post">
				<div class="form-inner">
					<div class="form-group">
			          ...
			          <div class="col-md-12">	
			      	 ...
			      	 <div class="col-md-12">	
			          	<label class="radio-inline">
		          			<input type="radio" name="sex" id="opman" value="男"> 男
		          		</label>
		          		<label class="radio-inline">
		          			<input type="radio" name="sex" id="opwoman" value="女"> 女
		          		</label>
		          		</div>
			          </div> 
			          </div> 
			          ...
			          <div class="col-md-12">	
			            ...
			            <input type="text" class="form-control" id="tele" name="tele" placeholder="">		            		            
			          </div>    
			              </div>	       
			    	<div class="form-group">
			          <div class="col-md-12">		          	
