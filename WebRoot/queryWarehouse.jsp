...
<html>
  <head>
	...
	if(pass!=null){
		response.sendRedirect("Doquery?q_wrhsInfo");
	}
...
<div class="show sss">
	<table>
		...
		System.out.println(i);%>
			<tr>
				<td><%=inv.get(i).getWh_no() %></td>
				<td><%=inv.get(i).getWh_name() %></td>
				<td><%=inv.get(i).getWh_adrs() %></td>
				<td><%=inv.get(i).getWh_contain() %></td>
				<td><%=inv.get(i).getAdmins() %></td>
				<td><a href="modifywh.jsp?row=<%=i %>">修改</a></td>
			</tr>
			<%} 
			}%>
			</tbody>
