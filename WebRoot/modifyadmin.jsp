...
<html>
  <head>
	...
	<%
	Vector<AdminInfo> inv=null;
	AdminInfo modi_admin=new AdminInfo();
	int power=99;
	...
	if(hs.getAttribute("adminInfo")!=null){
		inv=(Vector<AdminInfo>)hs.getAttribute("adminInfo");
		modi_admin=inv.get(row);
	}
	 %>
  </head>
...
<br/><br/>
<br/>
<h1 class="margin-bottom-18">创建帐户</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="Adminreg?action=modify" method="post">
				<div class="form-inner">
					<div class="form-group">
			     
			          <div class="col-md-12">	
			                      <label for="name" class="control-label">管理员姓名</label>
			            <input type="text" class="form-control" id="name" name="name" value=<%=modi_admin.getAd_name() %>>		          	
			      	 ...
			      	 <div class="col-md-12">	
			          	...
			          	String nan="";
			          	String nv="";
			          	if(modi_admin.getAd_sex().equals("男")){
			          		nan="checked";
			          	} 
			          	else{
			          		nv="checked";
			          ...
			          <div class="col-md-12">	
			            ...
			            <input type="text" class="form-control" id="tele" name="tele" value=<%=modi_admin.getAd_tele() %>>		            		            
			          </div>    
			              </div>	       
			    	<div class="form-group">
			          <div class="col-md-12">		          	
			           
			            <label for="warehouse" class="control-label center">所属仓库</label>
			          <select style="width:100px;" name = "warehouse">
			          <% 
     				...
     				Connection conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
			          ...
			          String sql = "select Sno from _Warehouse";
    				 ...
    				 while(rs.next()){%>  
						...
						System.out.println(modi_admin.getAd_belong());
						String s="";
						if(rs.getInt(1)==(modi_admin.getAd_belong())){
							s="selected";
							ms.setAttribute("mdfaid", modi_admin.getAd_no());
						}
						%>
						<%=s %>>
							<%s=""; %>
			          ...
			          <%--   <input type="text"  class="form-control" id="warehouse" name="warehouse" placeholder="">		--%>           		            		            
			          </div>
			          </div>	
