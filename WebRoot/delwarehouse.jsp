...
<h1 class="margin-bottom-18">删除仓库</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="warehousedel" method="post">
				<div class="form-inner">
			          ...
			          <div class="col-md-12">		          	
			            ...
			            <label for="admin" class="control-label center">空仓库： </label>
			          <select  style="width:100px;"  name = "admin"  onchange="showMsg(this)" >
			          <% 
     				...
     				Connection conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
			          ...
			          String sql = "select Sno,Sname from _Warehouse where Sno not in (select Sno from _Inventory)";
