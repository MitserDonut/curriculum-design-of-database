...
<h1 class="margin-bottom-18">出库表</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="regout" method="post">
				<div class="form-inner">
					<div class="form-group">
			     
			          <div class="col-md-6">	
			                      <label for="Gno" class="control-label">货物编号</label>
			             <select style="width:100px;"  name = "Gno">
			          <% 
     				...
     				Connection conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
			          ...
			          String sql = "select Gno from _Inventory";
    				 ...
    				 while(rs.next()){%>    				
			          ...
			          <div class="col-md-6">	
				         ...
				         <label for="Wno" class="control-label">员工</label>
			            <select style="width:100px;" name = "Wno">
			          <% 
			          Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
     				conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
     
			        sql = "select Wno from _Worker";
    				 ...
    				 while(rs.next()){%>    				
			          ...
			          <div class="col-md-6">	
				         ...
				         <label for="Sno" class="control-label">仓库号</label>
			            <select style="width:100px;" name = "Sno">
			          <% 
			          Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
     				conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
     
			        sql = "select Sno from _Inventory";
    		 		stmt=conn.createStatement();
    				  rs = stmt.executeQuery(sql);
    				 while(rs.next()){%>    				
						<option value ="<%=rs.getString(1) %>"  > <%=rs.getString(1)   %></option>
			          ...
			          <div class="col-md-6">	
				         ...
				         <label for="Ano" class="control-label">管理员</label>
			            <select style="width:100px;" name = "Ano">
			          <% 
			          Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
     				conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
     
			        sql = "select Ano from _Admin where Sno in (select Sno from _Inventory)";
    		 		stmt=conn.createStatement();
    				  rs = stmt.executeQuery(sql);
    				 while(rs.next()){%>    				
						<option value ="<%=rs.getString(1) %>"  > <%=rs.getString(1)   %></option>
			    	...
			    	<div class="form-group">
			    	 <div class="col-md-4">	
				         ...
				         <label for="date" class="control-label">出库日期:  年：</label>
			            <input type="text" class="form-control" id="year" name="year" placeholder="">	
			            </div>  
			             <div class="col-md-4">		            		            
			   			 <label for="date" class="control-label"> 月 ：</label>			   			 
			            <input type="text" class="form-control" id="month" name="month" placeholder="">
			            </div>  
			             <div class="col-md-4">	
			             <label for="date" class="control-label"> 日 ：</label>
			          ...
			          <div class="col-md-6">	
			           ...
			           <div class="col-md-6">	
				         ...
				         <label for="address" class="control-label">货物目的</label>
			      ...
			      <div class="col-md-6">	
				         ...
				         <label for="Cno" class="control-label">客户</label>
			            <select style="width:100px;" name = "Cno">
			          <% 
			          Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
     				conn= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=CangKu;user=sa;password=123");
     
			        sql = "select Cno from _Client";
    		 		stmt=conn.createStatement();
    				  rs = stmt.executeQuery(sql);
    				 while(rs.next()){%>    				
						<option value ="<%=rs.getString(1) %>"  > <%=rs.getString(1)   %></option>
			        ...
			        <div class="form-group">
			          <div class="col-md-12">
			            <input type="submit" value="出库" class="btn btn-info">
