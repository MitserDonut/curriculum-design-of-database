...
<h1 class="margin-bottom-18">破损表</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="lossreg" method="post">
				<div class="form-inner">
			        ...
			        sql = "select Ano from _Admin where Sno in (select Sno from _Inventory)";
			    	 ...
			    	 <div class="col-md-4">	
				         ...
				         <label for="date" class="control-label">破损日期:  年：</label>
			        ...
			        <div class="form-group">
			          <div class="col-md-12">
			            <input type="submit" value="登记" class="btn btn-info">
