...
<h1 class="margin-bottom-18">创建供应商</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="supplierreg?action=reg" method="post">
				<div class="form-inner">
					<div class="form-group">
			          ...
			          <div class="col-md-6">	
			           ...
			           <div class="col-md-6">	
			                      <label for="type" class="control-label">供应商商类型</label>
			        ...
			        <div class="form-group">
			          <div class="col-md-12">
			            <input type="submit" value="创建供应商" class="btn btn-info">
