...
<h1 class="margin-bottom-18">创建员工</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="goodsreg" method="post">
				<div class="form-inner">
					<div class="form-group">
			          ...
			          <div class="col-md-12">	
			            ...
			            <input type="text" class="form-control" id="name" name="name" placeholder="">		          	
			          	...
			          	<div class="form-group">
			      	 <div class="col-md-12">	
			          	 <label for="date" class="control-label">保质期</label>
			        ...
			        <div class="form-group">
			          <div class="col-md-12">
			            <input type="submit" value="添加货物" class="btn btn-info">
