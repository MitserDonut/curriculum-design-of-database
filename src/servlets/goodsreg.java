 ...
 */
@WebServlet("/goodsreg")
public class goodsreg extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="insert into _Goods(Gname,gdate,Gfactory,gprice) values("
				+ "?,?,?,?)";
		try {
			...
			prst.setString(3, request.getParameter("address"));
			prst.setDouble(4, Double.parseDouble(request.getParameter("price")));
